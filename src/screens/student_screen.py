...
def student_screen():
    ...
    if show_registration:
        with st.container(border=True):
            ...
            new_name = st.text_input("Enter your name", placeholder='E.g Champaklal Gada')
            ...
            try :
                audio_data = st.audio_input('Record a short phrase like I am present, My name is Tipendra.')
            except Exception:
                ...
                if new_name:
                    with st.spinner('Create Profile..'):
                        ...
                        if encodings:
                            ...
                            st.error('Coudnt capture your facial feature for registration')
