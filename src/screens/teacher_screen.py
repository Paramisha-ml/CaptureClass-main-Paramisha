...
from src.ui.base_layout import style_baground_dashboard, style_base_layout
...
def login_teacher(username, password):
    ...
    if teacher:
        st.session_state.user_rol = 'teacher'
...
def teacher_screen_login():
    ...
    st.space()
    st.space()
    teacher_username = st.text_input("Enter username", placeholder="Jethalal Champaklal Gada")
    ...
    with btncl1:
        if st.button("Login", icon=":material/passkey:",  type="primary", shortcut="control+enter", width="stretch"):
            if login_teacher(teacher_username, teacher_pass):
                ...
                st.error("Invalit username and password 😑")
    with btncl2:
...
def teacher_screen_register():
    ...
    st.space()
    teacher_username = st.text_input("Enter username", placeholder="Jethalal Champaklal Gada")
    teacher_name = st.text_input("Enter your name", placeholder="Jethalal Champaklal Gada")
    teacher_pass= st.text_input("Enter password", type="password", placeholder="Enter password")
    ...
    with btncl1:
        if st.button("Register now", icon=":material/passkey:",  type="primary", shortcut="control+enter", width="stretch"):
